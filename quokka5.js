(function (Scratch) {
    ...
    class QasmBuilder {
        ...
        getInfo() {
            ...
            return {
                ...
                blocks: [
                    ...
                    // Inverse container: no arguments, use branchCount and util.startBranch
        ...
        // Inverse container: run nested blocks via util.startBranch
        inverse(args, util) {
            console.log('🛠️ inverse start');
            const start = this.lines.length;
            util.startBranch(1, false);
            console.log('🛠️ lines after branch:', this.lines);
            ...
            console.log('🛠️ lines after inverse:', this.lines);
        }
